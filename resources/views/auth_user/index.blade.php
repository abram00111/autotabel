...
@section('content')
    ...
    <!--Modal Divizion-->
    <div class="modal fade" id="ModalDivizions" tabindex="-1" aria-labelledby="ModalDivizionsLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalDivizionsLabel">Добавление/редактирование подразделения</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
