...
/***/ "./resources/js/auth_user/divizion.js":
/*!********************************************!*\
  !*** ./resources/js/auth_user/divizion.js ***!
  \********************************************/
...
getAll(); //добавление подразделения

$(document).on('click', '#store_division', /*#__PURE__*/function () {
  var _add_division = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var user;
          ...
          case 0:
            ...
            $.ajax({
              ...
              success: function success(data) {
                var id_org = data['data']['id'];
                mes_right('success', 'Организация успешно добавлена');
                $('.all-organization').append('' + '<div class="col-12 mt-2 mb-2">\n' + '    <div class="head_organization">\n' + '        <div class="row">\n' + '            <div class="col-6">\n' + '                <h3>' + data['data']['short_name'] + '</h3>\n' + '            </div>\n' + '            <div class="col-6 buttons">\n' + '                <span class="add_divizion" data-id="' + id_org + '"><i class="fa fa-plus-square" aria-hidden="true"></i> Добавить подразделение</span>\n' + '                <span class="edit_organization" data-id="' + id_org + '"><i class="nav-icon fas fa-edit"></i></span>\n' + '                <span class="dell_organization" data-id="' + id_org + '"><i class="fa fa-trash" aria-hidden="true"></i></span>\n' + '            </div>\n' + '        </div>\n' + '    </div>\n' + '    <div class="body_organization">\n' + '        \n' + '    </div>\n' + '</div>');
                $('#close_add_organization').trigger('click');
              },
              error: function error(msg) {
                ...
                $.each(msg['responseJSON']['errors'], function (key, value) {
                  $('input[name="' + key + '"]').addClass('is-invalid');
                  $('input[name="' + key + '"]').after('' + '<span class="invalid-feedback d-block" role="alert">\n' + '   <strong>' + value + '</strong>\n' + '</span>');
                });
              }
            });
  ...
  function add_division() {
    return _add_division.apply(this, arguments);
  }
...
/***/ "./resources/js/auth_user/organization.js":
/*!************************************************!*\
  !*** ./resources/js/auth_user/organization.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            // $('#example tbody').html('');
            organizations['data'].forEach(function (organization) {
              var divisions = get_division(organization['id']);
              console.log(divisions['responseJSON']);
...
$(document).on('click', '#store_organization', /*#__PURE__*/function () {
  var _add_organization = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var user;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  function add_organization() {
    return _add_organization.apply(this, arguments);
  }
...
$(document).on('click', '#edit_organization', function () {
  var id = $('input[name="id_hid_organization"]').val();
  $.ajax({
    url: '/api/organization/' + id,
    type: "PUT",
    data: {
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          Swal.fire('Удалено!', 'Организация успешно удалена', 'success');
        },
        error: function error(msg) {
...
/*!**********************************!*\
  ...
  \**********************************/
__webpack_require__(/*! ./auth_user/organization */ "./resources/js/auth_user/organization.js");

__webpack_require__(/*! ./auth_user/divizion */ "./resources/js/auth_user/divizion.js");
})();
